...
public class TimeBubbleDrawable extends Drawable {
    ...
    public TimeBubbleDrawable(int pointerAlignment) {
    ...
    private void initBubble() {
        ...
        mColor = Color.parseColor("#ba0906");
