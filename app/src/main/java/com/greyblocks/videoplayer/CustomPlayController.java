 ...
 */
public class CustomPlayController extends FrameLayout {
    ...
    public CustomPlayController(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomPlayController(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, attrs);
    }

    public CustomPlayController(
    ...
    private void updateProgress() {
        ...
        if (playbackState != Player.STATE_IDLE && playbackState != Player.STATE_ENDED) {
            ...
            //Log.d(TAG,"eeeewrewrewrewrewrewrewrewrewrewrewr"+position);
